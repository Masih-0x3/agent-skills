---
name: dsl-vm-reverse
description: Reverse custom JavaScript or WASM virtual machines and risk engines. Use when a target contains an interpreter loop, encoded opcodes, constant tables, or a custom DSL runtime.
---
